document.addEventListener('DOMContentLoaded', function () {
    document.body.classList.add('no-scroll'); // Ẩn scrollbar khi load trang

    // Thời gian của animation (khớp với thời gian của fadeInUp)
    var animationDuration = 2000; // 1000ms = 1s

    // Khôi phục lại scrollbar sau khi animation kết thúc
    setTimeout(function () {
